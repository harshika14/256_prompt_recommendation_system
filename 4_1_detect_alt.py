    ...
    for count, image_path in enumerator:
        ...
        try:
            ...
            with open (FLAGS.output + "detection.txt", 'a') as f:
                ...
                ### WARNING: UNCOMMENT SECTION BUT BEWARE: IT CREATED JUNK FILES SO I DIDN'T USE THIS IN THE END FILES!!
            try:

                #df = pd.DataFrame()
                with open (FLAGS.output + "filenames_alt.txt", 'a') as f:
                    counter = 0
            ...
            try:
                ...
                #df = pd.DataFrame()
                with open (FLAGS.output + "scores_alt.txt", 'a') as f:
                    counter = 0
                    for i in score_list:
                        f.write(str(i) + "\n")
            except:
            ...
            try:
                ...
                #df = pd.DataFrame()
                with open (FLAGS.output + "classes_alt.txt", 'a') as f:
                    counter = 0
                    for i in class_list:
                        f.write(str(i) + "\n")
            except:
            ...
            try:
                ...
                #df = pd.DataFrame()
                with open (FLAGS.output + "class_names_alt.txt", 'a') as f:
                    counter = 0
